...
public class NewsLokaalFragment extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.fragment_news_lokaal, container, false);
        ...
        newsViewModel.getAllNewsArticles(getContext()).observe(this, news -> {
            RecyclerView recyclerViewLokaal = v.findViewById(R.id.news_lokaal_recyclerview);
            NewsRecyclerViewAdapter adapterLokaal = new NewsRecyclerViewAdapter(News.filterNews(news, "lokaal"), webView, this.getContext());
